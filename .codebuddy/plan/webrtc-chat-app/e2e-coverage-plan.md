...
- [~] P2-7 profile.spec.ts — block / unblock / blacklist
  persistence + in-session nickname edit (G25 resolved) +
  cross-reload nickname persistence (G28 resolved). "Avatar
  upload" still deferred to G26 (no UI affordance + no protocol
  field).
