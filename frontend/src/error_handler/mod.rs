...
mod error_toast_container;
mod error_toast_item;

pub use error_toast_container::ErrorToastContainer;
...
const AUTO_REMOVE_MS: i32 = 8_000;
...
pub struct ErrorToast {
  ...
  /// available.
  auto_remove_handle: Option<crate::utils::TimeoutHandle>,
}
...
impl ErrorToastManager {
  ...
  fn enforce_max_toasts(toasts: &mut Vec<ErrorToast>) {
